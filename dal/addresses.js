...
exports.Update = function(address_info, callback) {
    ...
    var values = [address_info.street, address_info.city,address_info.state,address_info.zip,address_info.address_id];
    connection.query('UPDATE addresses SET street = ?, city = ?, state = ?, zip = ? WHERE address_id = ?', values,
        function(err, result) {
...
exports.GetByID = function(address_id, callback) {
    ...
    var query = 'SELECT * FROM addresses WHERE address_id=' + address_id;
    console.log(query);
...
/* NOTE: Just like functions in other languages the parameters sent to a function do not need to have the same names
 ...
 this function.
 */
exports.Insert = function(address_info, callback) {
     ...
     */
    var dynamic_query = 'INSERT INTO addresses (street, city, state, zip) VALUES (' +
        '\'' + address_info.street + '\', ' +
        '\'' + address_info.city + '\', ' +
        '\'' + address_info.state + '\', ' +
        '\'' + address_info.zip + '\'' +
